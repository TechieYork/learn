...
import (
	...
	"comments/internal/pkg/common"
	"comments/internal/pkg/config"

	// !!!DO NOT EDIT!!!
	health_check "comments/api/protobuf_spec/health_check"
	comments "comments/api/protobuf_spec/comments"
	/*@PROTO_STUB*/
	HealthCheckServiceHandler "comments/internal/grpc_handler/HealthCheckService"
	CommentsServiceHandler "comments/internal/grpc_handler/CommentsService"
	/*@HANDLER_STUB*/
)
...
func (app *Application) runGRPCServer(address string) (grpcCloseFunc, error) {
	...
	comments.RegisterCommentsServiceServer(s, CommentsServiceHandler.CommentsServiceImpl{})
	/*@REGISTER_STUB*/
