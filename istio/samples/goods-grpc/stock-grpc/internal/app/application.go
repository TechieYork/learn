...
import (
	...
	"stock/internal/pkg/common"
	"stock/internal/pkg/config"

	// !!!DO NOT EDIT!!!
	health_check "stock/api/protobuf_spec/health_check"
	stock "stock/api/protobuf_spec/stock"
	/*@PROTO_STUB*/
	HealthCheckServiceHandler "stock/internal/grpc_handler/HealthCheckService"
	StockServiceHandler "stock/internal/grpc_handler/StockService"
	/*@HANDLER_STUB*/
)
...
func (app *Application) runGRPCServer(address string) (grpcCloseFunc, error) {
	...
	stock.RegisterStockServiceServer(s, StockServiceHandler.StockServiceImpl{})
	/*@REGISTER_STUB*/
