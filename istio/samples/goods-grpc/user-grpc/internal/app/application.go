...
import (
	...
	user "user/api/protobuf_spec/user"
	/*@PROTO_STUB*/
	HealthCheckServiceHandler "user/internal/grpc_handler/HealthCheckService"
	UserServiceHandler "user/internal/grpc_handler/UserService"
	/*@HANDLER_STUB*/
)
